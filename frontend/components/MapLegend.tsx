...
export default function MapLegend({
  ...
  return (
    <div
      ...
      className={`w-[22rem] max-w-[calc(100vw-3rem)] rounded-2xl border border-slate-200/90 bg-white/95 p-3.5 shadow-xl backdrop-blur-md transition-all text-slate-900 ${className}`}
    >
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded-md px-2 py-0.5 text-[11px] font-semibold text-slate-500 hover:bg-slate-100 hover:text-slate-800 transition-colors"
        >
      ...
      {!isCollapsed && (
        <div className="mt-2.5 space-y-2.5 text-xs">
          ...
          {showSkaArea && (
            <div>
              ...
              <div className="grid grid-cols-2 gap-1.5 text-[11px]">
                <div className="flex items-center gap-1.5 rounded-lg bg-rose-50/70 px-2 py-1 border border-rose-100/80">
                ...
                <div className="flex items-center gap-1.5 rounded-lg bg-orange-50/70 px-2 py-1 border border-orange-100/80">
                ...
                <div className="flex items-center gap-1.5 rounded-lg bg-amber-50/70 px-2 py-1 border border-amber-100/80">
                ...
                <div className="flex items-center gap-1.5 rounded-lg bg-emerald-50/70 px-2 py-1 border border-emerald-100/80">
          ...
          <div className="border-t border-slate-100 pt-2 space-y-1 text-[11px]">
            ...
            <div
              className={`flex items-center justify-between rounded-lg px-2 py-1 transition-opacity ${
            ...
            <div className="flex items-center justify-between rounded-lg px-2 py-1 bg-amber-50/80 border border-amber-200/60">
              <div className="flex items-center gap-2">
